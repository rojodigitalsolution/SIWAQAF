...
$column = array('nadzhir', 'jenis_kelamin', 'tgl_lahir', 'tpt_lahir', 'agama', 'pekerjaan', 'alamat');

$query = "SELECT * FROM nadzhir ";

if(isset($_POST['search']['value']))
{
 $query .= '
 WHERE nadzhir LIKE "%'.$_POST['search']['value'].'%" 
...
{
 $query .= 'ORDER BY id_nadzhir DESC ';
}

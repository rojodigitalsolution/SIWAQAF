<html>
 <head>
  ...
  <title>Laporan Data Wakif KUA Kecamatan X</title>
...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.5.6/css/buttons.dataTables.min.css">
 ...
 <body>
  ...
  <div class="container box">
   <h3 align="center">Laporan Data Wakif KUA Kecamatan X</h3>
   <br>
   <br>
   <div class="table-responsive">
    <table id="wakif-data" class="table table-bordered table-striped">
     <thead>
      <tr>
        <th>Wakif</th>
        <th>NIK</th>

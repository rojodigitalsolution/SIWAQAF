...
<html lang="en">
    <head>
        ...
        <title>Data Kelurahan - Wakaf Admin</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    {
                        //tambah
                        $sql = "INSERT INTO kelurahan VALUES ('','$kelurahan', 'kode' , '$warna')";
                    ...
                    {
                        //edit
                        $sql = "UPDATE kelurahan SET kelurahan = '$kelurahan', kode = '$kode' , warna = '$warna' WHERE id_kelurahan = '$id_kelurahan'";
                        if(mysqli_query($koneksi, $sql))
                        {
                    ...
                    <form method="post" action="">
                                ...
                                <table id="tabel-data" class="table table-striped table-hover">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $krow['kode']; ?></td>
                                            <td style="background: <?= $krow['warna']; ?>"></td>
                                            <td>
                                                <a href="#editEmployeeModal<?php echo $krow['id_kelurahan']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="#deleteEmployeeModal<?php echo $krow['id_kelurahan']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                        <!-- Edit Modal HTML -->
                        <div id="editEmployeeModal<?php echo $krow['id_kelurahan']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_kelurahan']; ?>" name="id_kelurahan" required>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>Kode</label>
                                                <input type="text" class="form-control" value="<?php echo $krow['kode']; ?>" name="kode" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Warna</label>
                                                <input type="color" class="form-control" value="<?php echo $krow['warna']; ?>" name="warna" required>
                                            </div>
                                        </div>
                        ...
                        <!-- Delete Modal HTML -->
                        <div id="deleteEmployeeModal<?php echo $krow['id_kelurahan']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_kelurahan']; ?>" name="id_kelurahan" required>

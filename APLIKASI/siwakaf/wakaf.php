        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    {
                        //tambah
                        $sql = "INSERT INTO wakaf VALUES ('', '$kelurahan', '$luas', '$penggunaan' , '$wakif','$nadzhir','$no_sertifikat','$tgl_sertifikat','$no_aiw')";
                    ...
                    {
                        //edit
                        $sql = "UPDATE wakaf SET kelurahan = '$kelurahan' , luas = '$luas' , penggunaan = '$penggunaan' , wakif = '$wakif', nadzhir = '$nadzhir', no_sertifikat = '$no_sertifikat', tgl_sertifikat = '$tgl_sertifikat', no_aiw = '$no_aiw' WHERE id_wakaf = '$id_wakaf'";
                        if(mysqli_query($koneksi, $sql))
                        {
                    ...
                    {
                        //delete
                        $sql = "DELETE FROM wakaf WHERE id_wakaf = '$id_wakaf'";
                        if(mysqli_query($koneksi, $sql))
                        {
                    ...
                    <form method="post" action="">
                                ...
                                <table id="tabel-data" class="table table-striped table-hover">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#editEmployeeModal<?php echo $krow['id_wakaf']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="#deleteEmployeeModal<?php echo $krow['id_wakaf']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                        <!-- Edit Modal HTML -->
                        <div id="editEmployeeModal<?php echo $krow['id_wakaf']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_wakaf']; ?>" name="id_wakaf" required>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $krow['kelurahan']; ?>" name="kelurahan" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Luas (m2)</label>
                                                <input type="text" class="form-control" value="<?php echo $krow['luas']; ?>" name="luas" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Penggunaan</label>
                                                <input type="text" class="form-control" value="<?php echo $krow['penggunaan']; ?>" name="penggunaan" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Wakif</label>
                                                <input type="text" class="form-control" value="<?php echo $krow['wakif']; ?>" name="wakif" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nadzhir</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $krow['no_sertifikat']; ?>" name="no_sertifikat" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Sertifikat</label>
                                                <input type="date" class="form-control" value="<?php echo $krow['tgl_sertifikat']; ?>" name="tgl_sertifikat" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nomor AIW</label>
                                                <input type="text" class="form-control" value="<?php echo $krow['no_aiw']; ?>" name="no_aiw" required>
                                            </div>
                                        </div>
                        ...
                        <!-- Delete Modal HTML -->
                        <div id="deleteEmployeeModal<?php echo $krow['id_wakaf']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_wakaf']; ?>" name="id_wakaf" required>
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete these Records <?php echo $krow['kelurahan']; ?>?</p>
                                ...
                                <div class="modal-content">
                                    <form method="post" action="">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>Penggunaan</label>
                                                <input type="text" class="form-control" name ="penggunaan" required>
                                                <!-- <textarea class="form-control" required></textarea> -->
                                            </div>
                                            <div class="form-group">
                                                <label>Wakif</label>
                                                <input type="text" class="form-control" name ="wakif" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nadzhir</label>
                                            ...
                                            <div class="form-group">
                                                <label>Nomor Sertifikat</label>
                                                <input type="text" class="form-control" name ="no_sertifikat" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Sertifikat</label>
                                            ...
                                            <div class="form-group">
                                                <label>Nomor AIW</label>
                                                <input type="text" class="form-control" name ="no_aiw" required>
                                            </div>                      
                                        </div>
                                        <div class="modal-footer">
                                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">

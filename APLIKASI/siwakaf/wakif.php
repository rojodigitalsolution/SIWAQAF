            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Wakif</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Wakif</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                Data Wakif di KUA Kecamatan X
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    {
                        //tambah
                        $sql = "INSERT INTO wakif VALUES ('','$wakif', '$nik' , '$jenis_kelamin', '$tgl_lahir', '$tpt_lahir', '$agama', '$pekerjaan', '$alamat')";
                    ...
                    {
                        //edit
                        $sql = "UPDATE wakif SET wakif = '$wakif', nik = '$nik' , jenis_kelamin = '$jenis_kelamin', tgl_lahir = '$tgl_lahir', tpt_lahir = '$tpt_lahir', agama = '$agama', pekerjaan = '$pekerjaan', alamat = '$alamat' WHERE id_wakif = '$id_wakif'";
                        if(mysqli_query($koneksi, $sql))
                        {
                    ...
                    {
                        //delete
                        $sql = "DELETE FROM wakif WHERE id_wakif = '$id_wakif'";
                        if(mysqli_query($koneksi, $sql))
                        {
                    ...
                    <form method="post" action="">
                                ...
                                <table id="tabel-data" class="table table-striped table-hover">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#editEmployeeModal<?php echo $krow['id_wakif']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="#deleteEmployeeModal<?php echo $krow['id_wakif']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                        <!-- Edit Modal HTML -->
                        <div id="editEmployeeModal<?php echo $krow['id_wakif']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_wakif']; ?>" name="id_wakif" required>
                        ...
                        <!-- Delete Modal HTML -->
                        <div id="deleteEmployeeModal<?php echo $krow['id_wakif']; ?>" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <form method="post" action="">
                                    <input type="hidden" class="form-control" value="<?php echo $krow['id_wakif']; ?>" name="id_wakif" required>
                                        ...
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete these Records <?php echo $krow['wakif']; ?>?</p>
